...
module Screen::Parser
  ...
  def parse_table(page, selector, remove_columns: [], include_header: false)
    generate_table_selector(page,selector).map_compact do |tr|
